...
export async function getStaticProps() {
    const treRes = await fetch(
        "https://newsapi.org/v2/top-headlines?language=en&pageSize=50&sortBy=publishedAt&apiKey=a6f1328365694d0788580c728c5249fb"
      );
...
<div className=" bg-[url('https://i.pinimg.com/originals/3d/08/e0/3d08e03cb40252526fee2036a67f07f1.gif')] bg-fixed ">
        ...
        <div className="  max-w-screen-xl  relative left-1/2 -translate-x-1/2 pt-20 pb-10  ">
        ...
        { trendingData.map((news , Index) =>{
            ...
            <Section key={Index} title={news.title} image={news.urlToImage} des={news.description} date= {" [ " + news.publishedAt + " ]"} link = {news.url} />
            )
